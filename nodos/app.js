...
usuarios().then((usuario) => {
  usuario.forEach(element => {
    ...
    $div.classList.add("box") //agregamos la clase al div
...
`
    ...
    $company.textContent = `Name Company: ${ element.name }` //accedemos por notacion de piuntos al objeto de la company

    const $address = document.createElement("p")
    $address.textContent = `City address: ${ element.city }`
